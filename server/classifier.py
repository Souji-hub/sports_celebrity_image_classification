...
def get_b64_test_image_for_virat():
    with open("server/test_images/kohli_b64.txt") as f:
        return f.read()

def displayfunc(data):
    for entry in data:
        print("Class:", entry['class'])
        print("Class Probability:", (entry['class_probability']))
        print("Class Dict:", entry['class_dictionary'])
...
if __name__ == '__main__':
    ...
    data = classify_image(get_b64_test_image_for_virat(), None)
    displayfunc(data)
    data = classify_image(None, "server/test_images/sharapova1.jpg")
    displayfunc(data)
